...
The second function, `factorialIter`, takes two arguments, one of which has a default value. Its name, `acc`, refers to the fact that such a way of solving a problem is sometimes called the '**Accumulator Pattern.**'
...
Let's look at the process generated by `functionIter`.
